       ...
       //GENERIC INPUT (email, search, tel, url, etc)
        ...
        //PASSWORD INPUT
        Jformz.prototype.inputPassword = function(jId,jClass,jName,jPh,jVal,jRequire){
       ...
       //HIDDEN INPUT 
        ...
        Jformz.prototype.numInput = function(jId,jClass,jName,jMin,jMax,jStep,jRequire){
         ...
         //DATETIME INPUT
        Jformz.prototype.dateTimeInput = function(jId,jClass,jName,jRequire){
            var j = '<input type="datetime-local" class="'+jClass+'" name="'+jName+'" id="'+jId+'" '+jRequire +' />';
            return j;     
        }          
        
         //TIME INPUT
        Jformz.prototype.timeInput = function(jId,jClass,jName,jRequire){
